...
#define I2C_DDR		DDRB	// Порт на котором реализуется I2C
#define I2C_PORT	PORTB	// Порт на котором реализуется I2C
#define I2C_PIN		PINB	// Порт на котором реализуется I2C

#define I2C_SCL		PORTB4	// Пин SCL
#define I2C_SDA		PORTB3	// Пин SDA

#define ACK 0		// Ответ удачный
#define NACK 1		// Ответ не удачный

#define I2C_DELAY()	asm("nop");	// Общая пауза на шине
